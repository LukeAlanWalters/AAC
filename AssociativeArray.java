...
public class AssociativeArray<K, V> {
  ...
  /** 
   * Gets all of the keys in the AssociativeArray and returns a String Array
   * @return - String[]
  */
  public String[] getKeys(){
    ...
    /** 
   * Gets all of the values in the AssociativeArray and returns a String Array
   * @return - String[]
  */
  public String[] getValues(){
    ...
    for (int i = 0; i < this.pairs.length; i++){
      if(!(this.pairs[i] == null)){
        values[i] = this.pairs[i].value.toString();
      }//if()
    }//for()
    return values;
  }//getKeys()
